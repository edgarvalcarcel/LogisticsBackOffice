...
namespace LogisticsBackOffice.Infrastructure.Migrations
{
    ...
    [Migration("20240315004435_RemovedIndexProject")]
    partial class RemovedIndexProject
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LogisticsBackOffice.Domain.Entities.Project", b =>
                {
                    ...
                    b.Property<int?>("ReceivingWorkerId")
                        .IsRequired()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LogisticsBackOffice.Domain.Entities.Project", b =>
                {
                    ...
                    b.HasOne("LogisticsBackOffice.Domain.Entities.Worker", "ReceivingWorker")
                        .WithMany()
                        .HasForeignKey("ReceivingWorkerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LogisticsBackOffice.Domain.Entities.WorkOrder", b =>
                {
                    b.HasOne("LogisticsBackOffice.Domain.Entities.Worker", "Operator")
                        .WithMany()
