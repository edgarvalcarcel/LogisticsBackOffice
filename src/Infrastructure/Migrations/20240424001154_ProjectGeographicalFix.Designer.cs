...
namespace LogisticsBackOffice.Infrastructure.Migrations
{
    ...
    [Migration("20240424001154_ProjectGeographicalFix")]
    partial class ProjectGeographicalFix
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LogisticsBackOffice.Domain.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LogisticsBackOffice.Domain.Entities.ServiceType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LogisticsBackOffice.Domain.Entities.WorkOrder", b =>
                {
                    ...
                    b.HasIndex("ProjectId", "ProjectDetailId", "ServiceId")
                        .IsUnique();

                    b.ToTable("WorkOrder");
                });

            modelBuilder.Entity("LogisticsBackOffice.Domain.Entities.WorkOrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("WorkOrderId", "WorkerId")
                        .IsUnique();
            ...
            modelBuilder.Entity("LogisticsBackOffice.Domain.Entities.Service", b =>
                {
                    b.HasOne("LogisticsBackOffice.Domain.Entities.ServiceType", "ServiceType")
                        .WithMany()
            ...
            modelBuilder.Entity("LogisticsBackOffice.Domain.Entities.WorkOrder", b =>
                {
                    ...
                    b.HasOne("LogisticsBackOffice.Domain.Entities.Contact", "Staff")
                        .WithMany()
