...
namespace LogisticsBackOffice.Infrastructure.Migrations
{
    ...
    [Migration("20240315002700_WorkerFixesField")]
    partial class WorkerFixesField
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LogisticsBackOffice.Domain.Entities.Worker", b =>
                {
                    ...
                    b.HasOne("LogisticsBackOffice.Domain.Entities.Project", "Project")
                        .WithOne("ReceivingWorker")
                        .HasForeignKey("LogisticsBackOffice.Domain.Entities.Worker", "ReceivingWorkerId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
