...
namespace LogisticsBackOffice.Infrastructure.Migrations
{
    ...
    [Migration("20231130033833_AddInitialTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LogisticsBackOffice.Domain.Entities.TodoItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LogisticsBackOffice.Domain.Entities.TodoList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LogisticsBackOffice.Domain.Entities.TodoItem", b =>
                {
                    b.HasOne("LogisticsBackOffice.Domain.Entities.TodoList", "List")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("LogisticsBackOffice.Domain.Entities.TodoList", b =>
                {
                    b.OwnsOne("LogisticsBackOffice.Domain.ValueObjects.Colour", "Colour", b1 =>
                        {
